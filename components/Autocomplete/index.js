  ...
  class Autocomplete extends Component {
    ...
    handleInputChange(text) {
      const {index, handleSelectItem, minimumCharactersCount, waitInterval} = this.props;
      clearTimeout(this.timer);
      this.setState({inputValue: text});
      handleSelectItem(text, index);
    ...
    async triggerChange() {
      ...
      const {fetchDataUrl, valueExtractor, dataArray} = this.props;
      if (fetchDataUrl) {
        try {
